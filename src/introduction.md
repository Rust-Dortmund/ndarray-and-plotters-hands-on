...
Let us calculate values and draw diagrams. If you're using Python for these task you'll find many similarities. But here, we'll stick to Rust and see how far we get!
...
- [mdBook](https://rust-lang.github.io/mdBook/) - YOU should install that, see the repository readme.
